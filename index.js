...
"A year later you wish you had started today",
"°It will be morning tonight, be patient°",
...
"When you are not well, memories come to you sooner than anyone else.",
...
client.on('message', msg => {
 if (msg.content === "textenglish", "te") {/////ba dlli xot la jegai sllaw shtek da bna
   msg.channel.send(`${rply[Math.floor(Math.random() * rply.length)]}`);
  }
});
