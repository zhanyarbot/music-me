...
async execute(message, args, client) {
    ...
    switch (args[0]) {
      ...
      default:
        ...
        .setTitle("")
        .setDescription(`
<a:emoji_44:823439273914269716> | Filters | <a:emoji_44:823439273914269716>

\`bassboost\` . \`8D\` . \`vaporwave\` . \`nightcore\` . \`phaser\` . \`tremolo\` . \`vibrato\` . \`surrounding\` . \`pulsator\` . \`subboost\`. \`clear\`

`)
        .setFooter(`Example: ${PREFIX}fi 8D`)
        )
        break;
    }
    //set choice to zero
