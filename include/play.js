  ...
  async play(song, message, client, filters) {
    ...
    if (!song) {
      ...
      const endembed = new MessageEmbed().setColor("YELLOW")
        .setAuthor(`Music Queue ended.`, "https://cdn.discordapp.com/attachments/822637229297238026/833218301542924308/20210418_084342.png")
  ...
  let thumb;
    ...
    try {
      const newsong = new MessageEmbed()
       .setTitle(" <a:emoji_10:850608290308292628>"+song.title)
        .setURL(song.url)
        .setColor("YELLOW")
        .setImage(thumb)
        ...
        .addField("<a:emoji_24:850633169978916864> Volume:", `\`100\``, true)
